      ...
      <div class="manager-main-left">
        ...
        >
          ...
          <el-sub-menu index="1">
            ...
            <el-menu-item index="/manager/type" v-if="data.user.role === 'ADMIN'">心理分类</el-menu-item>
            <el-menu-item index="/manager/topic" v-if="data.user.role === 'ADMIN'">题库信息</el-menu-item>
            <el-menu-item index="/manager/topic" v-if="data.user.role === 'DOCTOR' && data.user.status === '审批通过'">题库信息</el-menu-item>
            <el-menu-item index="/manager/testPaper" v-if="data.user.role === 'ADMIN'">试卷信息</el-menu-item>
            <el-menu-item index="/manager/testPaper" v-if="data.user.role === 'DOCTOR' && data.user.status === '审批通过'">试卷信息</el-menu-item>
            ...
            <el-menu-item index="/manager/reservation" v-if="data.user.role === 'ADMIN'">医生预约记录</el-menu-item>
            <el-menu-item index="/manager/reservation" v-if="data.user.role === 'DOCTOR' && data.user.status === '审批通过'">预约记录审批</el-menu-item>
